export default function Jumbotron() {
  return (
    <>
      <div class="grid place-items-center  bg-slate-200 ">
        {" "}
        <div class="w-80 justify-center items-center rounded-xl overflow-auto p-8 place-items-center ">
          <div class="grid grid-cols-2 divide-x font-mono text-sm text-center font-bold leading-6 rounded-lg shadow-lg overflow-hidden dark:divide-slate-700 justify-center items-center">
            <div class="p-2 text-slate-400 bg-white">
            ...
            <div class="p-4 text-slate-400 bg-white">All Countries</div>
          </div>
        </div>
      </div>

      <div class="flex justify-center py-4 bg-slate-200">
        <div class="absolute left-12  font-bold">Invest Now</div>
        <div div class="absolute right-10 font-bold">Seek Investment</div>
      </div>
    </>
  );
}
