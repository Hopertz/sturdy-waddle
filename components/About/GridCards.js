...
function GridCards(props) {
  return (
    <>
      {/* Card 1 */}
      <div>
        <h1 className="ml-8 mb-2 uppercase text-xl font-semibold">
          Who we are
        </h1>
        <div className="m-8 mt-0 p-8 bg-white shadow-lg rounded-xl">
          <p>
            {" "}
          ...
          <p>
            Odio nisl volutpat porttitor libero ultricies vel habitant convallis
            sagittis. Amet viverra congue dictum enim laoreet. Commodo amet
            turpis malesuada magnis at rhoncus tristique sit.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="m-8 mt-0 p-8  md:min-h-[456px] bg-white shadow-lg rounded-xl">
      ...
      <div>
        <h1 className="ml-8 mb-2 uppercase text-xl font-semibold">Contacts</h1>
        <div className="m-8 mt-0 p-8  md:min-h-[456px] bg-white shadow-lg rounded-xl">
          <div className="flex space-x-8 items-center">
            ...
            <div>
              <p>Alpha (T) Company Ltd</p>
              <p>info@alpha.co.tz</p>
              <p>+255714 213123</p>
            </div>
          </div>
